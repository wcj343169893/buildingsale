			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" height="26">
				<tr>
					...
					<td align="right" style="padding-top:5px;">
						<input type="button" value="编辑" class="tab_but" onclick="doback('~loft!toUpUnit.action?unitinfo.unitId=${unitBean.unitId }');" />
						<input type="button" value="返回" class="tab_but" onclick="doback('~loft!toloftmanager.action?loftinfto.loftId=${unitBean.loftInfo.loftId }')"/>
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		...
		<td>
			...
			<div style="width:100%;margin:11px 2px 2px 2px;">
				...
				<table border="0" cellpadding="2" style="float:left;" cellspacing="0">
					<tr>
