...
public class LoftInfo implements java.io.Serializable {
	...
	/**
	 * loftId属性的set方法
	 * @param loftId the loftId to set
	 */
	 ...
	 * @param dataDictByLoftComtyType the dataDictByLoftComtyType to set
	 */
	 ...
	 * @param dataDictByLoftBuildType the dataDictByLoftBuildType to set
	 */
	...
	/**
	 * loftNo属性的set方法
	 * @param loftNo the loftNo to set
	 */
	...
	/**
	 * loftName属性的set方法
	 * @param loftName the loftName to set
	 */
	...
	/**
	 * loftZone属性的set方法
	 * @param loftZone the loftZone to set
	 */
	...
	/**
	 * loftAddress属性的set方法
	 * @param loftAddress the loftAddress to set
	 */
	...
	/**
	 * loftPrice属性的set方法
	 * @param loftPrice the loftPrice to set
	 */
	 ...
	 * @param loftBeginTime the loftBeginTime to set
	 */
	 ...
	 * @param loftShellOutTime the loftShellOutTime to set
	 */
	 ...
	 * @param loftFinishTime the loftFinishTime to set
	 */
	 ...
	 * @param loftCapacity the loftCapacity to set
	 */
	...
	/**
	 * loftGreen属性的set方法
	 * @param loftGreen the loftGreen to set
	 */
	...
	/**
	 * loftTraffic属性的set方法
	 * @param loftTraffic the loftTraffic to set
	 */
	 ...
	 * @param loftFacility the loftFacility to set
	 */
	...
	/**
	 * loftRemark属性的set方法
	 * @param loftRemark the loftRemark to set
	 */
	...
	/**
	 * shopInfos属性的set方法
	 * @param shopInfos the shopInfos to set
	 */
	...
	/**
	 * unitInfos属性的set方法
	 * @param unitInfos the unitInfos to set
	 */
